...
{
		cout<<"\n\t\t\t ----------------------------------";
		cout<<"\n\t\t\t\t MOVIE CINEMA BOX OFFICE";
		cout<<"\n\t\t\t ----------------------------------";
		cout<<"\n\t\t\t\t Welcome Dear Customer!";	 																					//Menu for the user
		cout<<"\n\n\t\t\t\t [1] Movie Selection and Ticket Booking";
...
int main(){
	system("CLS");
	system("title Movie Booking System");
	//Integer Declaration
	...
	switch(choice)
		{
			...
			cout<<"\n\t\t\t\t 4. Yaariyan 2";
			cout<<"\n\t\t\t\t\t  Hindi";
			cout<<"\n\t\t\t\t\t  Drama, Comedy, Music, Romance U";
			cout<<"\n\t\t\t\t 5. Neethone Nenu";
			cout<<"\n\t\t\t\t\t  Telugu";
			cout<<"\n\t\t\t\t\t  Drama,Romance U\n";
			cout<<"\n\t\t\t\tEnter Your Choice :"<<"\t";
			cin>>movie;
			cout<<"\n\n\t\t\t\t The Timing for the selected show are:";
			switch(movie)
			{
				case 1:
					system("CLS");
					...
					if (strlen(t.cno)!=10)
    				{
        				cout<<"\t\t\t\t Provide us a valid contact number please!";
						cin>>t.cno;
					...
					switch(b)
						{
							case 1:	cout<<"08:00 AM";
								break;
							case 2:	cout<<"13:00 PM";
								break;
							case 3:	cout<<"14:50 PM";
								break;
							case 4:	cout<<"18:00 PM";
								break;
							case 5:	cout<<"21:00 PM";
								break;
				...
				case 3: 
				system("CLS");
				cout<<"\n\n\t\t\t\t Dear Customer Please Select the timing:";
					cout<<"\n\t\t\t\t 1. 08:00 AM";
					cout<<"\n\t\t\t\t 2. 13:00 PM";
					cout<<"\n\t\t\t\t 3. 14:50 PM";
					cout<<"\n\t\t\t\t 4. 18:00 PM";
					cout<<"\n\t\t\t\t 5. 21:00 PM";
					cout<<"\n\t\t\t\t 6. 01:00 AM";
					cout<<"\n\t\t\t\t Please select the timing for your Show";
					cin>>b;
